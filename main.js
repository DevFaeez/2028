$(function(){
  ...
  const globalState = {
    apps: [
      {
        name: 'Calendar',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fcalendar.png?alt=media&token=ae918b56-05c3-40a1-be64-1abcdb291c6f',
        type: 'widgetFull',
        dinamico: true
      },
      ...
      {
        name: 'Weather',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fclima.png?alt=media&token=02edb357-5775-4bf1-91c0-8e3f4908ddea',
        type: 'app',
        dinamico: false
      },
      {
        name: 'FaceTime',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ffacetime.png?alt=media&token=4c66d073-d44e-4671-878e-6a8dd1dc7956',
        type: 'app',
        dinamico: false
      },
      {
      ...
      {
        name: 'Clock',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Freloj.png?alt=media&token=d0d76558-79c6-4d21-8fe7-1d13de3a6a3e',
        type: 'app',
        dinamico: true
      },
      {
        name: 'Photo',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ffotos.png?alt=media&token=86d712fd-aab1-48a3-a6d0-f2b5b7f9a2ab',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Map',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fmaps.png?alt=media&token=309018b2-981a-44fd-bf97-8da765fef711',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Camera',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fcamara.png?alt=media&token=bd81cee7-b011-4773-a053-a7cd935e34c3',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Reminders',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Frecordatorios.png?alt=media&token=2dbccbc3-374b-4eed-aa00-68db99217b7d',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Facebook',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ffacebook.png?alt=media&token=f383d17e-32a7-49ef-8ebb-c723d556baa2',
        type: 'app',
        notifications: 5,
        dinamico: false
      },
      {
        name: 'Notes',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fnotas.png?alt=media&token=7a25ae1c-9010-48e4-81e8-e04a904024e9',
        type: 'app',
        dinamico: false
      },
      {
        name: 'App Store',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fappstore.png?alt=media&token=fe121a13-738f-43cd-936b-45ee7fb90cec',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Health',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fsalud.png?alt=media&token=fee7445d-600c-4146-a590-1adc1d40001b',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Messages',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fmensajes.png?alt=media&token=e389ae38-bbeb-4ca9-aa46-4be8a5b6ca90',
        notifications: 123,
        type: 'app',
        dinamico: false
      },
      {
        name: 'Settings',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fconfiguracion.png?alt=media&token=dfe6b4dd-0b50-4a78-8ef1-22728ed9840c',
        type: 'app',
        notifications: 3,
        dinamico: false
      },
      {
        name: 'BBVA',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fbbva.png?alt=media&token=840b9fa7-c765-4147-9138-8234eabfeb9e',
        type: 'app',
        dinamico: false
      },
      {
        name: 'WhatsApp',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fwhatsapp.png?alt=media&token=b3416a44-56fc-4991-a10b-e4a34944bf3c',
        type: 'app',
        notifications: 22,
        dinamico: false
      },
      {
        name: 'Calculator',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fcalculadora.png?alt=media&token=0ce89e65-2e11-408c-8467-39637f0f19f8',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Twitter',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ftwitter.png?alt=media&token=4360a8ea-afce-4f20-9057-bb2d4d5a9e41',
        type: 'app',
        notifications: 2,
        dinamico: false
      },
      {
        name: 'Messenger',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fmessenger.png?alt=media&token=5de5ef16-9bbf-4d79-b9d2-2e416106b21c',
        notifications: 3,
        type: 'app',
        dinamico: false
      },
      {
        name: 'Compass',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fbrujula.png?alt=media&token=b4e4b1bb-1048-427d-836e-7d8b599d71e0',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Spotify',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fspotify.png?alt=media&token=f538e504-a8d7-4707-a308-8d4bc2b6f7f6',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Pinterest',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fpinterest.png?alt=media&token=4ad25035-0875-4000-ba39-5541234494c1',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Google Home',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fhome.png?alt=media&token=b6f455b0-7333-4c4a-b866-56e900beb41e',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Tersakiti',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fliverpool.png?alt=media&token=42dfbbba-2149-4fe0-b503-419513082039',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Music',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fmusica.png?alt=media&token=4ee18c65-11d5-46bb-8c4f-3536e49e33b0',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Netflix',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fnetflix.png?alt=media&token=88ddda95-de2f-44e6-b8a1-d5016f801e1c',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Recorder',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fnotasvoz.png?alt=media&token=dddc5de3-e91f-41da-8670-26ccddf54471',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Wallet',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fwallet.png?alt=media&token=96369c3a-d6f4-434f-9049-7b934c35af60',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Podcasts',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fpodcast.png?alt=media&token=166e653d-d060-46e6-9274-3a4d368d7ec4',
        type: 'app',
        dinamico: false
      },
      {
        name: 'File Manager',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Farchivos.png?alt=media&token=b4ce6b1b-9877-41ca-a0f3-b05526591495',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Contact',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fcontactos.png?alt=media&token=fe1b3525-ef43-4a68-91ec-82b3f7b6b979',
        type: 'app',
        dinamico: false
      },
      {
        name: 'YouTube',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fyoutube.png?alt=media&token=180f2d4c-32bf-4d40-855c-c70148d727e9',
        notifications: 1,
        type: 'app',
        dinamico: false
      },
      {
        name: 'Find My iPhone',
        icon: 'https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ffindphone.png?alt=media&token=9b0106d2-b151-49af-a3d9-dfbd64bc4421',
        type: 'app',
        dinamico: false
      },
      {
        name: 'Tiktok',
        icon: 'https://g.foolcdn.com/image/?url=https%3A%2F%2Fg.foolcdn.com%2Feditorial%2Fimages%2F554039%2Ftiktok-logo.png&op=resize&w=700',
        type: 'app',
        notifications: 7,
        dinamico: false
      }
  ...
  $.fn.extend({
    ...
    calendar: function(config){
      ...
      let mes = globalState.dateTime.month[config.fecha.getMonth()];
      let dayMes = new Date(config.fecha.getFullYear(), (config.fecha.getMonth() + 1), 0).getDate();
      let hoy = config.fecha.getDate();
      let primerDays = new Date(config.fecha.getFullYear(), config.fecha.getMonth(), 0).getDay();
      this.append(`
<div class="mes">
...
<div class="tablaContent"></div>
      ...
      globalState.dateTime.day.map(days => header.append(`<div class="diaName">${config.daysCompleto ? days : days.charAt(0)}</div>`))
      for (var k = 0; k <= primerDays; k++) {
        content.prepend('<div></div>');
      }
      for (let index = 1; index <= dayMes; index++) {
        content.append(`<div class="daysNum ${hoy == index ? 'active':''}">${index}</div>`);
      }
      return this;
    },
    fechaicon: function(config){
      config = jQuery.extend({
        fecha: new Date(),
        daysCompleto: false
      }, config);
      let hoy = config.fecha.getDate();
      let days = globalState.dateTime.day[config.fecha.getDay()];
      this.append(`<div class="fechaWrapper"><p class="diaNom">${config.daysCompleto ? days : days.substring(0, 3)}</p><p class="daysNum">${hoy}</p></div>`);
      return this;
    },
    clock: function(){
      let tiempo = new Date();
...
<div class="manecilla segundos" style="transform: rotate(${transformSegundos});"><div class="barra"></div></div>
    ...
    fecha: function (config) {
      ...
      let days = globalState.dateTime.day[config.fecha.getDay()];
      let mes = globalState.dateTime.month[config.fecha.getMonth()];
      this.text(`${config.daysCompleto ? days : days.substring(0, 3)}, ${hoy} th ${mes}`);
      return this;
    },
  })
  ...
  function pintarApps(apps, container, containerDots){
    ...
    apps.map((app, idArr) => {
      ...
      if (app.dinamico && app.type == 'app') clases = `${clases} ${sanearString(app.name).toLowerCase()}Dinamico`;
      html += `<div class="${clases}" data-app="${app.type + sanearString(app.name)}" data-id="${idArr}">
${app.notifications ? `<div class="notificacion">${app.notifications}</div>` : ''}
<div class="icon" style="${!app.dinamico ? `background-image:url(${app.icon});` : 'background-color:#fff;'}"></div>
...
<p class="header">${config.header}</p>
...
<video src="./asset/videoplayback.mp4" autoplay="true" loop="true"></video>
</div>
<div class="modesCamera">
<div class="mode">wide</div>
<div class="mode">Video</div>
<div class="mode active">Photo</div>
<div class="mode">Potrait</div>
<div class="mode">Panorrama</div>
</div>
<div class="obturadorArea">
<div class="imgPreview" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSj3c4jwIsCJhatrzSrvN1tjlmJZ9_zvGLjoSsLUJ7c_g&s);"></div>
...
<path d="M62 38l-7.259-9.86L46 36"></path>
  ...
  function renderizarUI(){
    //We paint all the apps in the main container
    pintarApps(globalState.apps, $('.wrapperApps'), $('.wrapperDots'));
    //If the calendar widget exists
    if ($('.wrapperApps .app[data-app="widgetFullCalendar"]').length) {
      //Preparamos el widget del calendar
      $('.wrapperApps .app[data-app="widgetFullCalendar"] .icon').append('<div class="event"><p>No more events for today</p></div><div class="calendarWrapper"></div>');
      //Creamos el calendar del widget
      $('.wrapperApps .app[data-app="widgetFullCalendar"] .icon .calendarWrapper').calendar();
    }
    //Si existe el icon dinamico del calendar
    if ($('.wrapperApps .app.calendarDinamico').length) {
      //icon dinamico del calendar
      $('.wrapperApps .app.calendarDinamico .icon').fechaicon();
    }
    //Si existe el reloj analogico dinamico
    if ($('.wrapperApps .app.clockDinamico').length) {
      //Reloj analogico dinamico
      $('.wrapperApps .app.clockDinamico .icon').clock();
    }
  }
  function encendido(){
    renderizarUI();
  ...
  //Event del days en la pantalla de widgetsCenter
  $('.widgetCenter .block.event').fechaicon({daysCompleto: true});
  ...
  $('.lockScreen').touchMov({
    ...
    movUp: function(e){
      ...
      //Timeout para simular el agotamiento de la baterry
      if (!globalState.baterryBaja) {
        setTimeout(() => {
          alertaiOS({
            header: 'Low Battery',
            mensaje: '20% battery remaining',
            acciones: [
              {
                texto: 'Ok'
              }
          ...
          $('.mainScreen .statusBar .baterry').removeClass('mid').addClass('low');
          globalState.baterryBaja = true;
        }, 3000);
      }
    }
  });
  $('.wrapperApps').touchMov({
    ...
    movIzq: function (e) {
      ...
      $('.wrapperDots .dot').eq(globalState.wrapperApps.grupoActive - 1).addClass('active');
    },
    movDer: function (e) {
...
`);
  ...
  $('body').on('click', '.fixedMenuFixedApp .menuOption.eliminar', function () {
    ...
    alertaiOS({
      header: `¿Transferir ${idApp !== undefined ? globalState.apps[idApp].name : 'app'} a la biblioteca de apps o eliminar la app?`,
...
function myFunc() {
  var text = document.getElementById("moreAboutMe-details");
  var list = document.getElementById("allMedia");
  if (text.style.display === "none") {
    text.style.display = "block";
    list.style.display = "none";
    alert("Click again for close")
  } else {
...
// document.getElementById("moreAboutMe-button").addEventListener("click", function() {
//   document.getElementById("moreAboutMe-details").style.display = "none";
// });